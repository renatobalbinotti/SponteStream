...
<div>
    ...
    <dl class="dl-horizontal">
        ...
        <dd>
            @Html.TextBoxFor(Function(model) model.NOME, "", New With {.NOME = Model.NOME,
                                                                                                                    .readonly = "true",
                                                                                                                    .Class = "form-control"})
        ...
        <ddDATANASCIMENTO @Html.TextBoxFor(Function(model) model.DATANASCIMENTO, "{0:yyyy-MM-dd}", New With {.value = Model.DATANASCIMENTO, .readonly = "true", .Class = "form-control", .type = "date"})
...
<p>
    @Html.ActionLink("Editar", "Edit", New With {.id = Model.IDINSCRITO}) |
