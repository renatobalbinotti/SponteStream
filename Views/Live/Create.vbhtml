...
@Using (Html.BeginForm("Create", "LiveController", FormMethod.Post))
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.TextBoxFor(Function(model) model.DATAHORAINICIO, "{0:yyyy-MM-dd}", New With {.Class = "form-control", .type = "date"})
