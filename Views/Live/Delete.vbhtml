...
<div>
    ...
    <h6> Tem certeja que deseja deletar @Model.NOME</h6>
    <hr />
    <dl class="dl-horizontal">
        ...
        <dd>
            @Html.TextBoxFor(Function(model) model.DATAHORAINICIO, "{0:yyyy-MM-dd}", New With {.value = Model.DATAHORAINICIO,
                                                                                                          .readonly = "true",
                                                                                                          .Class = "form-control",
                                                                                                          .type = "date"})
...
<p>
    @Using (Html.BeginForm("Delete", "LiveController", FormMethod.Post))
